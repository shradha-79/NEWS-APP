...
export default class App extends Component {
  ...
  apiKey = "12d821effca7408dacd4ab0ff73959ed";
  state = {
    progress:0
  }
    ...
    return <div>
      ...
      />
        <Routes>
          ...
          <Route exact path="/NEWS-APP" element={<News setProgress={this.setProgress} apiKey={this.apiKey}  key="general" pageSize={this.pageSize} country="in" category="general" />}></Route>
